...
class TestAdvancedThreadSafetyPatterns:
    ...
    def test_reader_writer_pattern(self):
        ...
        with ThreadPoolExecutor(max_workers=8) as executor:
            writer_futures = [
                executor.submit(writer, 0, 25),
                executor.submit(writer, 25, 50)
            ]
    ...
    def test_event_bus_thread_safety(self):
        ...
        with ThreadPoolExecutor(max_workers=10) as executor:
            ...
            sub_futures = [
                ...
                executor.submit(subscriber, "type_A"),  # Multiple subscribers for same type
            ]
    ...
    def test_weak_reference_cleanup_thread_safety(self):
        ...
        with ThreadPoolExecutor(max_workers=5) as executor:
            futures = [
                executor.submit(create_and_register_objects, i*10, (i+1)*10)
                for i in range(5)
            ]
