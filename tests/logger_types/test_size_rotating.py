...
class TestSizeRotatingLog:
    ...
    def test_size_rotating_log_initialization(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            size_log = SizeRotatingLog(name="test_size", directory=temp_dir, level="INFO")
    ...
    def test_size_rotating_log_init_method(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            size_log = SizeRotatingLog(name="test_init", directory=temp_dir, filenames=["test.log"])
    ...
    def test_size_rotating_log_context_manager(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            with SizeRotatingLog(name="test_context", directory=temp_dir) as logger:
                assert isinstance(logger, logging.Logger)
    ...
    def test_size_rotating_log_context_manager_cleanup(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            size_log = SizeRotatingLog(name="test_cleanup", directory=temp_dir)
    ...
    def test_size_rotating_log_with_stream_handler(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            size_log = SizeRotatingLog(name="test_stream", directory=temp_dir, streamhandler=True)
            logger = size_log.init()
    ...
    def test_size_rotating_log_cleanup_logger_error_handling(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            size_log = SizeRotatingLog(name="test_error_cleanup", directory=temp_dir)
            logger = size_log.init()
    ...
    def test_size_rotating_log_actual_logging(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            size_log = SizeRotatingLog(name="test_actual", directory=temp_dir, filenames=[log_file], level="INFO")
            logger = size_log.init()
